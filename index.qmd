...
library(tidyverse)
plan <- readxl::read_excel("lecturePlan.xlsx")
plan[is.na(plan)] <- " "
plan <- plan %>% 
  select(-Comments)
knitr::kable(plan)
...
Textbook (@hyndman2018) chapters 1-9 and 13. Additional notes by lecturer on volatility forecasting. All the material on this website.
