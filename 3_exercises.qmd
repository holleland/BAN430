...
1.  Use the simulated data from [here](https://holleland.github.io/BAN430/3_componentsandseasonaladjustment.html#sec-componentsandseasonaladjustment). Compare different methods with the truth from the simulation. Are there large differences?
