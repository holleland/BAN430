...
Gives one row per series with columns like `trend_strength` and `seasonal_strength_year` - see [Section 4.3 of the textbook](https://otexts.com/fpp3/stlfeatures.html) for the full list.
