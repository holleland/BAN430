...
c)  We can also use **STL features** to assess and compare h*ow* seasonal or trending a series is rather than just eyeballing a decomposition (see [Section 4.3 of the textbook](#0)). Aggregate `windpower` to **monthly** data for **both** locations (like `wp_month` in the graphics lab), then run:
