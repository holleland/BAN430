...
\sigma_t^2 &=\alpha_0 +\alpha_1y_{t-1}^2+\cdots+\alpha_ry_{t-r}^2 + \beta_1\sigma_{t-1}^2+\cdots+\beta_s\sigma_{t-s}^2,
\end{split}
\end{equation*}
or
\begin{equation*}
...
$$\sigma^2= \mathbb E\sigma_t^2 \mathbb E\,\varepsilon_t^2 =\mathbb E\sigma_t^2=\alpha_0+\alpha_1\mathbb E\,y_{t-1}^2+\beta_1 \mathbb E\,\sigma_{t-1}^2$$
...
$$\sigma^2 =\alpha_0+\alpha_1 \sigma^2+\beta_1\sigma^2\quad \Leftrightarrow \quad \sigma^2 =\frac{\alpha_0}{1-\alpha_1-\beta_1}.$$
...
$$y_t^2 = \alpha_0+\alpha_1y_{t-1}^2 +\beta_1\underbrace{\sigma_{t-1}^2}_{y_{t-1}^2-v_{t-1}} +v_t = \alpha_0+(\alpha_1+\beta_1)y_{t-1}^2-\beta_1v_{t-1}+ v_t.$$
We can write this as
$$(1-(\alpha_1+\beta_1)\,B)\,y_t^2 = \alpha_0+(1-\beta_1\,B)v_t,$$
which we can recognize as an ARMA(1,1) with intercept $c=\alpha_0$, $\phi_1 = \alpha_1+\beta_1$, $\theta_1 = -\beta_1$ and $v_t$ is the white noise process (assuming $\mathbb E\,y_t^4<\infty$)
